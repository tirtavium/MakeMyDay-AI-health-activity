...
class MediterranesnDietView extends StatelessWidget {
  ...
  final String? minimumCarbsIntake;
  final String? minimumProteinIntake;
  final String? bodyFatPercentage;
  final double? caloriesPerDay;

  const MediterranesnDietView(
      {Key? key, this.animationController, this.animation, this.minimumCarbsIntake, this.minimumProteinIntake, this.bodyFatPercentage, this.caloriesPerDay})
      : super(key: key);
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Text(
                                            '${(caloriesPerDay! * animation!.value).toInt()}',
                                            textAlign: TextAlign.center,
                                            style: const TextStyle(
                                              fontFamily:
                                                  FitnessAppTheme.fontName,
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 6),
                                      child: Text(
                                        '$minimumProteinIntake grams left',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                          fontFamily: FitnessAppTheme.fontName,
                                          fontWeight: FontWeight.w600,
